      ...
      >
        ...
        <div className="w-full md:w-[48%] bg-[#20152F] relative flex flex-col p-8 md:p-12 overflow-hidden text-white min-h-[400px] md:min-h-0">
           ...
           <div className="flex items-center gap-3 relative z-10 mb-8">
              ...
              <span className="font-bold text-2xl tracking-wide">IBA Corpration</span>
           </div>

           {/* Hero Text */}
           <div className="relative z-10">
              <h1 className="text-2xl md:text-3xl lg:text-4xl font-extrabold leading-[1.1] tracking-tight mb-4 md:mb-6">
                Smarter<br/>
                Attendance<br/>
           ...
           {/* Robot Area */}
           <div className="mt-1 md:mt-2 relative z-10 flex flex-col items-center justify-end pt-1">
             {!robotActive && (
               <div 
               ...
               >
                 {/* Platform */}
                 <div className="absolute bottom-0 w-60 md:w-80 h-16 md:h-20 bg-[#291A3A] rounded-[100%] border-t-2 border-[#5B2A72] shadow-[0_0_30px_rgba(91,42,114,0.6)] flex items-center justify-center">
                 ...
                 >
                   <motion.img 
                     ...
                     src={ibaMascotFull} 
                     alt="Robot Mascot" 
                     className="w-52 h-52 md:w-60 md:h-60 object-contain drop-shadow-[0_20px_20px_rgba(0,0,0,0.5)]" 
                   />
                 </motion.div>
               </div>
             )}
        ...
        <div className="w-full md:w-[52%] bg-white relative flex flex-col justify-center p-6 md:p-10 lg:p-14">
           ...
           <div className="flex flex-col gap-6 w-full max-w-[460px] mx-auto mt-2">
             ...
             <motion.div 
               ...
               className="group cursor-pointer bg-[#C6F135] rounded-[28px] p-6 flex items-center gap-5 shadow-[0_15px_30px_rgba(198,241,53,0.2)] hover:shadow-[0_20px_40px_rgba(91,42,114,0.3)] transition-shadow duration-150 relative overflow-hidden"
             ...
             >
               ...
               <div className="flex-grow relative z-10">
                 <h3 className="text-xl font-bold text-[#20152F] mb-1">Employee</h3>
                 <p className="text-[#20152F]/70 text-sm leading-snug">
                   Face Attend Check in-out
                 </p>
               </div>
